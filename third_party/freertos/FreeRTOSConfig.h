...
#define configMAX_SYSCALL_INTERRUPT_PRIORITY (5 << (8 - __NVIC_PRIO_BITS)) /* equivalent to 0xb0, or priority 11. */
...
NVIC value of 255. */
#define configLIBRARY_KERNEL_INTERRUPT_PRIORITY ((1 << __NVIC_PRIO_BITS) - 1)
